...
public class SitesPanel {
	...
	public void setField(SiteObject site) {
		...
		Helper.setField(site.city, elements.CITY_FIELD, 2);	
		Helper.setField(site.state, elements.STATE_FIELD, 3);	
		Helper.setField(site.country, elements.COUNTRY_FIELD, 4);	
		Helper.setField(site.postalCode, elements.POSTAL_CODE_FIELD, 5);	
	}
