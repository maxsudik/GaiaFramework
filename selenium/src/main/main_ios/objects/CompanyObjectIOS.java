...
public abstract class CompanyObjectIOS {
  ...
  public static class Builder extends CompanyObjectIOS_Builder{
      ...
      public CompanyObjectIOS withDefaultCompany() {
          ...
          .leaglBirthdayMonth(LEGAL_BIRTHDAY_MONTH_SPINNER)
          .leaglBirthdayDay(LEGAL_BIRTHDAY_DAY_SPINNER)
          .leaglBirthdayYear(LEGAL_BIRTHDAY_YEAR_SPINNER)
          .legalAddressLine1(LEGAL_ADDRESS_LINE_1_FIELD)
          .legalAddressLine2(LEGAL_ADDRESS_LINE_2_FIELD)
          ...
          //Scan Credit Card
          .cardNumber(CARD_NUMBER_FILED)
          .MMYY(MM_YY_FIELD)
          .CVV(CVV_FILED)
          
          //Credit Card Information
          .creditCardNameOnCard(CREDIT_CARD_NAME_ON_CARD_FIELD)
          .creditCardLicenseDDLMI(CREDIT_CARD_LICENSES_DDLMI)
          .creditCardAddressLine1(CREDIT_CARD_ADDRESS_LINE_1_FIELD)
          .creditCardAddressLine2(CREDIT_CARD_ADDRESS_LINE_2_FIELD)
          .creditCardCity(CREDIT_CARD_CITY_FILED)
          .creditCardCountry(CREDIT_CARD_COUNTRY_DDLMI)
          .creditCardState(CREDIT_CARD_STATE_DDLMI)
